...
Good documentation is pretty short in nature, telling the *why* instead of the *what*.
...
You should be able to zip the whole project folder, send it to a person that can ask you no questions but is competent.
